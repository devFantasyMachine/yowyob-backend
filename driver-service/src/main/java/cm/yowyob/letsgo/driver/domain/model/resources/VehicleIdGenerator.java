...
public class VehicleIdGenerator implements ResourceIdGenerator{
    ...
    public String generate(UserResource userResource) {
        ...
        return "V-" + LocalDateTime.now().toEpochSecond(ZoneOffset.UTC) + "-" + HexFormat.of().formatHex(plain).toUpperCase();
    }
