...
public class PoolerRoutine extends RoutineTrip<PoolerPlan>{

    public PoolerRoutine(LocalDateTime beginAt, LocalDateTime endAt, LocalDateTime nextActivation, Duration repeatInterval, Boolean isCron, String cron, Long repeatCount, Long repeatCountMax, JobStatus jobStatus) {
