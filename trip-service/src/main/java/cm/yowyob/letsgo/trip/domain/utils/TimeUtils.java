...
/**
 * Time utility getMethods. See the unit test for examples on how to use this class.
 */
public class TimeUtils {
  ...
  /** This is a utility class. Do not instantiate this class. It should have only static getMethods. */
  private TimeUtils() {}
