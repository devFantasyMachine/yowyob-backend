...
export default function ProfileDropdown({ onProfileClick, user }: { onProfileClick: () => void, user?: User }) {
    ...
    <div className="text-left z-10">
      <Menu as="div" className="relative inline-block top-1 md:top-[2px]">
        ...
        <Transition
          ...
          <Menu.Items className="absolute z-50 left-[-80px] lg:right-0 lg:left-auto mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 p-3 focus:outline-none">
